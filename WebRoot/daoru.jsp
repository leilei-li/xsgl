...
<form action="Inport_xls?ip=<%out.print(getIpAddr(request)); %>" name="daoru"  method="post">
<lable>
<select name="daoruleixing" id="daoruleixing">
  <option>导入客户</option>
  <option>导入员工</option>
  <option>导入订单</option>
  <option>导入对账单</option>
  ...
  <option>导入科室</option>
  <option>导入发票</option>
  <option selected="selected">导入团队</option>
</select>
</lable>
