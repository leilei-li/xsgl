...
<form action="Inport_cus" name="daoru"  method="post" enctype="multipart/form-data" >
<lable><input type="file" name="file" id="file"></lable>
<lable><input type="button" name="Submit" value="导入" onClick="daoru_tishi()"></lable>
</form>
<p>-----------------------------</p>
<p>下面可以写上一大堆的各种说明: <br/>
1、不提供模板，可以直接用原来系统按照业务区导出的表格。</br>
2、导入之前请将要导入的表格另存为： 地区名.xls （如: 北京北5区.xls, 不要直接重命名，用excel打开后另存为即可,注意后缀是xls）<br/>
3、系统将会自动添加科室及单位，不需要手动输入.</p>
</body>
</html>
