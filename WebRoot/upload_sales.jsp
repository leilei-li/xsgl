...
<form action="Inport_sales" name="daoru"  method="post" enctype="multipart/form-data" >
<lable><input type="file" name="file" id="file"></lable>
<lable><input type="button" name="Submit" value="导入" onClick="daoru_tishi()"></lable>
</form>
<p><a href="/xsgl/moban/moban_sales.xls" >下载员工导入模板</a></p>
<p>-----------------------------</p>
<p>下面可以写上一大堆的各种说明: <br/>
由于主流的浏览器都不再支持获取本地文件绝对路径，所以采用的办法是把文件转化成二进制上传到服务器，再从服务器里面导入了，测试是否会自动换行</p>
</body>
</html>
