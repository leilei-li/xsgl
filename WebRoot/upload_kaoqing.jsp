...
<body>
	<div id="massage_box">
		<div class="massage">
			<div class="header" onmousedown="MDown(massage_box);">
				<div style="display: inline; width: 150px; position: absolute">System
					Information</div>
				<span
			...
			<div style="margin-top: 30px; margin-left: 30px">
				<img src="images/loading.gif" align="absmiddle"
					style="width: 50px; height: 50px" />&nbsp;&nbsp;&nbsp;正在上传，请等待页面的自动跳转...
			</div>
		</div>
	</div>
	<div id="mask"></div>
	...
	<table width="800" height="506" border="0" scrolling="NO ">
		...
		<form action="Inport_kaoqing" name="daoru" method="post"
			enctype="multipart/form-data">
			<lable> <input type="file" name="file" id="file"></lable>
			<lable> <input type="button" name="Submit" value="导入"
				onClick="daoru_tishi()"></lable>
		</form>
		<p>-----------------------------</p>
		<p>
			下面可以写上一大堆的各种说明: <br />
			由于主流的浏览器都不再支持获取本地文件绝对路径，所以采用的办法是把文件转化成二进制上传到服务器，
			再从服务器里面导入了,直接导入txt文件，后台会自动读取当天的
		</p>
</body>
</html>
