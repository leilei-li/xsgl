...
public class dingdan_newServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String dingdanhao=request.getParameter("dingdan_ID");
		...
		ub=ubb.creatDingdan(dingdan_ID,date,type,dingdanhao,cus_ID,sales_ID,state,fapiao,yangpinmiaoshu,
				sample_num,price1,sell_off1,1,shoufei_num,0);
