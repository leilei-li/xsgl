...
public class fapiao_modifyServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		ub=ubb.modifyFapiao(fapiao_ID,fapiao_num,create_date,dingdan_ID,money1,cus_ID,sales_ID,shishou1,state,fapiaotaitou,
				user_ID);
