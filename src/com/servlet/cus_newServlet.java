...
public class cus_newServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		boolean ub=false,gb=false;
		cusBeanOP ubb=new cusBeanOP();
		ub=ubb.creatCus(cus_ID,name,sex,type,mobile1,mobile2,phone,keshi_name,role,
				task,advance_money1,hobby,jifen1,keyan_money1,chengguo,position,protity1,state,email,danwei_name,area_name);
